...
Template.UMeditProfile.onCreated(function(){
	Meteor.subscribe('userfunction');

});

Template.UMeditProfile.helpers({
	edit: ()=> {
 ...
 if(!window.fileData1){fileData1 = '';}
        ...
        if( urlUID == loggedInUser){
           ...
           Meteor.call('updateUserByUser', urlUID, doc , userFormValues); 
            ...
            Meteor.call('sendEmail1', to , from, subject ,body);
            Bert.alert( 'User Data Edited!', 'success', 'growl-top-right' );
        }else{
